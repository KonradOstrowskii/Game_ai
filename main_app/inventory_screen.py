...
class InventoryScreen:
    ...
    def draw_tooltip(self, surface, item, position):
        ...
        for i, line in enumerate(lines):
            text = self.tooltip_font.render(line, True, (255, 255, 255))
    ...
    def draw(self, surface):
        ...
        if self.player.inventory and 0 <= self.selected_index < len(self.player.inventory):
            ...
            for i, line in enumerate(lines):
                info_text = self.info_font.render(line, True, (255, 255, 255))
            ...
            pygame.draw.rect(surface, (50, 50, 80), info_rect)
            info_text = self.info_font.render("Inventory is empty.", True, (255, 255, 255))
        ...
        btn_text = self.font.render("Return", True, (255, 255, 255))
        ...
        for i, line in enumerate(eq_lines):
            eq_text = self.info_font.render(line, True, (255, 255, 255))
