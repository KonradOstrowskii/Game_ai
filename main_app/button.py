...
class Button:
    ...
    """
    def __init__(self, x, y, width, height, text, action=None, color=DARK_GRAY, hover_color=HOVER_COLOR):
    ...
    def handle_event(self, event):
        ...
        if event.type == pygame.MOUSEMOTION:
            if self.rect.collidepoint(event.pos):
                ...
                self.current_color = self.color if not self.is_selected else SELECTED_COLOR
